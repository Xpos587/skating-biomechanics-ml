...
from skating_ml.types import BladeState3D, MetricResult
...
from skating_ml.visualization.core.text import draw_text_box, put_text
...
def draw_blade_indicator_hud(
    ...
    Example:
        >>> from skating_ml.types import BladeState3D, BladeType, MotionDirection
...
def _get_blade_color(blade_type) -> tuple[int, int, int]:
    """Get color for blade type."""
    from skating_ml.types import BladeType
