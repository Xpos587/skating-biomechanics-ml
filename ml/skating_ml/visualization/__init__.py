...
Example:
    >>> from skating_ml.visualization import VisualizationConfig, LayerConfigs, SkeletonLayer
...
# HUD
from skating_ml.visualization.hud import (
    HUDLayout,
    HUDPanel,
    PanelPosition,
    Position,
...
# Layers
from skating_ml.visualization.layers import (
    AnglePanelLayer,
    BladeLayer,
    HUDLayer,
    JointAngleLayer,
...
# Skeleton
from skating_ml.visualization.skeleton import (
    draw_skeleton,
    draw_skeleton_3d,
